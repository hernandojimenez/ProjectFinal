...
public class GeneralTestUtils {
    ...
    public static List<Part> getPartsDB() {
        ...
        parts.add(new Part(1L, 12345678, "Motor V8", 80, 80, 80, 60, new StockCM(1L, 4), new Provider(1L, "Ford"), partRecordSet1));
        parts.add(new Part(2L, 87654321, "Caja de cambios", 30, 50, 40, 20, new StockCM(2L, 48), new Provider(1L, "Fiat"), partRecordSet2));
        parts.add(new Part(3L, 11223344, "Llantas", 100, 20, 100, 50, new StockCM(3L, 80), new Provider(1L, "Chevrolet"), partRecordSet3));
