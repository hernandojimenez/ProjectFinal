...
public class OrderController {
    ...
    @GetMapping("/orders")
    public ResponseEntity<?> getParts(@RequestParam Map<String, String> params, @RequestParam(required = false) String orderNumber,  @RequestHeader("Authorization") String token) throws Exception {
